    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
            <form onSubmit={handleAddProduct} className="bg-white p-6 rounded shadow-md space-y-4 w-full max-w-md">
                ...
                <input ref={nameRef} type="text" placeholder="Product Name" required className="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                ...
                <input ref={categoryRef} type="number" placeholder="Category ID" required className="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" />
